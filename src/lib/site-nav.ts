...
export const SITE_NAV: { label: string; items: SiteNavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/site/hero", label: "トップ掲載商品", icon: LayoutGrid, description: "トップページに大きく出す商品と順番", ready: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/site/media", label: "ムービー・メディア", icon: Clapperboard, description: "ダイジェストムービーと掲載メディア", ready: true },
    ],
  },
  {
    label: "サイト全体",
    items: [
      ...
      { href: "/site/banner", label: "バナー・サイト設定", icon: Megaphone, description: "上部バナー・OGP・フッター・プライバシーポリシー", ready: true },
    ],
  },
];
